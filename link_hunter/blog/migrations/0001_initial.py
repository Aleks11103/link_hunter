    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create', models.DateField(auto_now_add=True, verbose_name='Create date.')),
                ('text', models.TextField(verbose_name='Record content.')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content', to=settings.AUTH_USER_MODEL, verbose_name='User.')),
            ],
            options={
                'verbose_name': 'Blog',
